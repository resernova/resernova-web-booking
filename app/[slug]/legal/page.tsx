      ...
      <section className="mt-8 space-y-6 leading-relaxed text-[var(--color-text)]">
        <Section title="1. Responsable du traitement">
          <p>
            ...
            collectées via cette page est <strong>{salon.businessName}</strong>.
            Pour toute demande relative à vos données, contactez{" "}
            <a
              href="mailto:privacy@resernova.com"
              className="text-[var(--color-primary-500)] underline"
            >
        ...
        <Section title="2. Données collectées">
          <ul className="list-disc space-y-1 pl-6">
            <li>
              Nom complet et numéro de téléphone (obligatoires pour confirmer
              votre réservation)
            </li>
            <li>Adresse e-mail (optionnelle, pour recevoir la confirmation)</li>
            <li>
              Adresse IP (hachée SHA-256, conservée 24 h uniquement pour la
              sécurité anti-spam)
            </li>
        ...
        <Section title="3. Finalités">
          ...
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              Vous envoyer un rappel 24 h avant votre rendez-vous (si vous y
              avez consenti)
            </li>
        ...
        <Section title="4. Base légale">
          <p>
            ...
            (cases à cocher explicites) et sur l'
            <strong>exécution du contrat</strong> de réservation.
          </p>
        </Section>
        ...
        <Section title="5. Durée de conservation">
          <ul className="list-disc space-y-1 pl-6">
            <li>
              Données de réservation : conservées tant que la relation
              contractuelle dure
            </li>
            <li>
              Adresse IP (hachée) : 24 heures, puis supprimée automatiquement
            </li>
            <li>
              Cookies : aucun cookie de tracking n'est déposé sur cette page
            </li>
          </ul>
        </Section>
        ...
        <Section title="6. Vos droits (Loi 09-08)">
          <p>
            Conformément à la loi marocaine 09-08, vous disposez d'un droit d'
            <strong>accès</strong>, de <strong>rectification</strong>, d'
            <strong>opposition</strong> et de <strong>suppression</strong> de
        ...
        <Section title="7. Sécurité">
          <p>
            Toutes les communications sont chiffrées en TLS 1.3. Les jetons
            d'auto-gestion sont signés par HMAC-SHA256 et expirent après 7
            jours. Aucun mot de passe n'est nécessaire pour gérer votre
            réservation.
          </p>
        </Section>
        ...
        <Section title="8. Hébergement">
          <p>
            Les données sont hébergées chez Supabase Inc. (infrastructure cloud
            sécurisée, certifications SOC 2 Type II et ISO 27001). Les serveurs
            sont localisés en Europe.
          </p>
        </Section>
